...
Partial Public Class FirmDetailDataContext
  ...
  End Sub
  Partial Private Sub InsertFirmDetail(instance As FirmDetail)
    End Sub
  Partial Private Sub UpdateFirmDetail(instance As FirmDetail)
    End Sub
  Partial Private Sub DeleteFirmDetail(instance As FirmDetail)
    End Sub
  #End Region
	...
	Public ReadOnly Property FirmDetails() As System.Data.Linq.Table(Of FirmDetail)
		Get
			Return Me.GetTable(Of FirmDetail)
		End Get
	End Property
End Class

<Global.System.Data.Linq.Mapping.TableAttribute(Name:="dbo.FirmDetails")>  _
Partial Public Class FirmDetail
	...
	Private _FloatRequired As Decimal
	
	Private _GrossSalesHighlight As Decimal
	
	Private _GrossCashupDifHighlight As Decimal
	
	Private _OverbakeHighlight As Decimal
	
	Private _DiscountHighlight As Decimal
	
	Private _StaffMealHighlight As Decimal
	
	Private _GeneralDefaultDirectory As String
	
	Private _SQLBackupDefaultDirectory As String
	
	Private _HoursPerShift As Decimal
    ...
    End Sub
    Partial Private Sub OnFirmNameChanging(value As String)
    End Sub
    Partial Private Sub OnFirmNameChanged()
    End Sub
    ...
    End Sub
    Partial Private Sub OnFloatRequiredChanging(value As Decimal)
    End Sub
    Partial Private Sub OnFloatRequiredChanged()
    End Sub
    Partial Private Sub OnGrossSalesHighlightChanging(value As Decimal)
    End Sub
    Partial Private Sub OnGrossSalesHighlightChanged()
    End Sub
    Partial Private Sub OnGrossCashupDifHighlightChanging(value As Decimal)
    End Sub
    Partial Private Sub OnGrossCashupDifHighlightChanged()
    End Sub
    Partial Private Sub OnOverbakeHighlightChanging(value As Decimal)
    End Sub
    Partial Private Sub OnOverbakeHighlightChanged()
    End Sub
    Partial Private Sub OnDiscountHighlightChanging(value As Decimal)
    End Sub
    Partial Private Sub OnDiscountHighlightChanged()
    End Sub
    Partial Private Sub OnStaffMealHighlightChanging(value As Decimal)
    End Sub
    Partial Private Sub OnStaffMealHighlightChanged()
    End Sub
    Partial Private Sub OnGeneralDefaultDirectoryChanging(value As String)
    End Sub
    Partial Private Sub OnGeneralDefaultDirectoryChanged()
    End Sub
    Partial Private Sub OnSQLBackupDefaultDirectoryChanging(value As String)
    End Sub
    Partial Private Sub OnSQLBackupDefaultDirectoryChanged()
    End Sub
    Partial Private Sub OnHoursPerShiftChanging(value As Decimal)
    End Sub
    Partial Private Sub OnHoursPerShiftChanged()
    End Sub
    Partial Private Sub OnAttachmentDirectoryChanging(value As String)
    End Sub
    Partial Private Sub OnAttachmentDirectoryChanged()
    End Sub
    #End Region
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_FirmName", DbType:="VarChar(50) NOT NULL", CanBeNull:=false)>  _
	Public Property FirmName() As String
		Get
			Return Me._FirmName
		End Get
		Set
			If (String.Equals(Me._FirmName, value) = false) Then
				Me.OnFirmNameChanging(value)
				Me.SendPropertyChanging
				Me._FirmName = value
				Me.SendPropertyChanged("FirmName")
				Me.OnFirmNameChanged
			End If
		End Set
	End Property
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_BankName", DbType:="VarChar(30)")>  _
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_BranchName", DbType:="VarChar(30)")>  _
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_AccountType", DbType:="VarChar(30)")>  _
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_FloatRequired", DbType:="Decimal(13,2) NOT NULL")>  _
	Public Property FloatRequired() As Decimal
		Get
			Return Me._FloatRequired
		End Get
		Set
			If ((Me._FloatRequired = value)  _
						= false) Then
				Me.OnFloatRequiredChanging(value)
				Me.SendPropertyChanging
				Me._FloatRequired = value
				Me.SendPropertyChanged("FloatRequired")
				Me.OnFloatRequiredChanged
			End If
		End Set
	End Property
	
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_GrossSalesHighlight", DbType:="Decimal(13,2) NOT NULL")>  _
	Public Property GrossSalesHighlight() As Decimal
		Get
			Return Me._GrossSalesHighlight
		End Get
		Set
			If ((Me._GrossSalesHighlight = value)  _
						= false) Then
				Me.OnGrossSalesHighlightChanging(value)
				Me.SendPropertyChanging
				Me._GrossSalesHighlight = value
				Me.SendPropertyChanged("GrossSalesHighlight")
				Me.OnGrossSalesHighlightChanged
			End If
		End Set
	End Property
	
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_GrossCashupDifHighlight", DbType:="Decimal(13,2) NOT NULL")>  _
	Public Property GrossCashupDifHighlight() As Decimal
		Get
			Return Me._GrossCashupDifHighlight
		End Get
		Set
			If ((Me._GrossCashupDifHighlight = value)  _
						= false) Then
				Me.OnGrossCashupDifHighlightChanging(value)
				Me.SendPropertyChanging
				Me._GrossCashupDifHighlight = value
				Me.SendPropertyChanged("GrossCashupDifHighlight")
				Me.OnGrossCashupDifHighlightChanged
			End If
		End Set
	End Property
	
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_OverbakeHighlight", DbType:="Decimal(13,2) NOT NULL")>  _
	Public Property OverbakeHighlight() As Decimal
		Get
			Return Me._OverbakeHighlight
		End Get
		Set
			If ((Me._OverbakeHighlight = value)  _
						= false) Then
				Me.OnOverbakeHighlightChanging(value)
				Me.SendPropertyChanging
				Me._OverbakeHighlight = value
				Me.SendPropertyChanged("OverbakeHighlight")
				Me.OnOverbakeHighlightChanged
			End If
		End Set
	End Property
	
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_DiscountHighlight", DbType:="Decimal(13,2) NOT NULL")>  _
	Public Property DiscountHighlight() As Decimal
		Get
			Return Me._DiscountHighlight
		End Get
		Set
			If ((Me._DiscountHighlight = value)  _
						= false) Then
				Me.OnDiscountHighlightChanging(value)
				Me.SendPropertyChanging
				Me._DiscountHighlight = value
				Me.SendPropertyChanged("DiscountHighlight")
				Me.OnDiscountHighlightChanged
			End If
		End Set
	End Property
	
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_StaffMealHighlight", DbType:="Decimal(13,2) NOT NULL")>  _
	Public Property StaffMealHighlight() As Decimal
		Get
			Return Me._StaffMealHighlight
		End Get
		Set
			If ((Me._StaffMealHighlight = value)  _
						= false) Then
				Me.OnStaffMealHighlightChanging(value)
				Me.SendPropertyChanging
				Me._StaffMealHighlight = value
				Me.SendPropertyChanged("StaffMealHighlight")
				Me.OnStaffMealHighlightChanged
			End If
		End Set
	End Property
	
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_GeneralDefaultDirectory", DbType:="VarChar(255)")>  _
	Public Property GeneralDefaultDirectory() As String
		Get
			Return Me._GeneralDefaultDirectory
		End Get
		Set
			If (String.Equals(Me._GeneralDefaultDirectory, value) = false) Then
				Me.OnGeneralDefaultDirectoryChanging(value)
				Me.SendPropertyChanging
				Me._GeneralDefaultDirectory = value
				Me.SendPropertyChanged("GeneralDefaultDirectory")
				Me.OnGeneralDefaultDirectoryChanged
			End If
		End Set
	End Property
	
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_SQLBackupDefaultDirectory", DbType:="VarChar(255)")>  _
	Public Property SQLBackupDefaultDirectory() As String
		Get
			Return Me._SQLBackupDefaultDirectory
		End Get
		Set
			If (String.Equals(Me._SQLBackupDefaultDirectory, value) = false) Then
				Me.OnSQLBackupDefaultDirectoryChanging(value)
				Me.SendPropertyChanging
				Me._SQLBackupDefaultDirectory = value
				Me.SendPropertyChanged("SQLBackupDefaultDirectory")
				Me.OnSQLBackupDefaultDirectoryChanged
			End If
		End Set
	End Property
	
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_HoursPerShift", DbType:="Decimal(13,2) NOT NULL")>  _
	Public Property HoursPerShift() As Decimal
		Get
			Return Me._HoursPerShift
		End Get
		Set
			If ((Me._HoursPerShift = value)  _
						= false) Then
				Me.OnHoursPerShiftChanging(value)
				Me.SendPropertyChanging
				Me._HoursPerShift = value
				Me.SendPropertyChanged("HoursPerShift")
				Me.OnHoursPerShiftChanged
			End If
		End Set
	End Property
	
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_AttachmentDirectory", DbType:="VarChar(255)")>  _
	Public Property AttachmentDirectory() As String
		Get
			Return Me._AttachmentDirectory
		End Get
		Set
			If (String.Equals(Me._AttachmentDirectory, value) = false) Then
				Me.OnAttachmentDirectoryChanging(value)
				Me.SendPropertyChanging
				Me._AttachmentDirectory = value
				Me.SendPropertyChanged("AttachmentDirectory")
				Me.OnAttachmentDirectoryChanged
			End If
		End Set
	End Property
