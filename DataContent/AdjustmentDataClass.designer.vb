...
Partial Public Class AdjustmentDataContext
  ...
  End Sub
  Partial Private Sub InsertAdjustmentRequested(instance As AdjustmentRequested)
    End Sub
  Partial Private Sub UpdateAdjustmentRequested(instance As AdjustmentRequested)
    End Sub
  Partial Private Sub DeleteAdjustmentRequested(instance As AdjustmentRequested)
    End Sub
  #End Region
	...
	Public ReadOnly Property AdjustmentRequesteds() As System.Data.Linq.Table(Of AdjustmentRequested)
		Get
			Return Me.GetTable(Of AdjustmentRequested)
		End Get
	End Property
End Class

<Global.System.Data.Linq.Mapping.TableAttribute(Name:="dbo.AdjustmentRequested")>  _
Partial Public Class AdjustmentRequested
